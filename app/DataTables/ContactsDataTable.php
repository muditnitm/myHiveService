...
class ContactsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->editColumn('description', function ($todo) {
            $url = route('contact.description', $todo->id);
        ...
        if (\Laratrust::hasPermission('contact delete')) {
            $rowColumn[] = 'action';
            $dataTable->addColumn('action', function (ContactUs $contact) {
    ...
    // this function for get business and run query according it
     ...
     */
    public function query(ContactUs $model, Request $request): QueryBuilder
    {
        $business_id    = ($request->business) ? $request->business : getActiveBusiness();
    ...
    public function getColumns(): array
    {
        $column =  [
            ...
            Column::make('subject')->title(__('Title')),
