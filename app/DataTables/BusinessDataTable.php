...
class BusinessDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))->addIndexColumn()
            ->editColumn('name', function (Business $business) {
                return  '<span class="white-space"><a href="' . route('business.manage', $business->id) . '">' . $business->name . '</a></span>';
            })
            ->addColumn('action', function (Business $business) {
                return view('business.action', compact('business'));
            })
    ...
    {
        return $model->where('businesses.created_by', creatorId());
    }
