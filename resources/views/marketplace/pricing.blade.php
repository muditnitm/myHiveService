                            ...
                            <div class="summery-footer">
                                    ...
                                    <li>
                                        <span class="cart-sum-left">
                                            <h6 class="mb-0">{{ __('Business') }} <small
                                                    class="text-muted business-price">{{ '( Per Business ' . $businessprice . $currancy_symbol . ' )' }}</small>
                                            </h6>
                                        </span>
                                        <span class="cart-sum-right"><b
                                                class="businesspricetext">{{ '0.00' . $currancy_symbol }}</b></span>
                                    </li>
                                    <li>
                                        <span class="cart-sum-left">
                                ...
                                <div class="cart-footer-total-row d-flex align-items-center justify-content-between">
                                    <div class="mini-total-price">
                                        <div class="price">
                                            <ins><span
                                                    class="currency-type total">{{ super_currency_format_with_sym($planprice) }}</span></ins>
                        ...
                        <div class="review-content">
                            <div class="section-title">
                                ...
                                <h2>{{ __('A style theme, together with a dedicated Laravel backend') }}
                                    <b>{{ __('and an intuitive mobile app') }}</b>
                                </h2>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name"
                                        value="" required="required" autocomplete="name" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="store_name" type="text" class="form-control" name="business_name"
...
@push('scripts')
    <script>
        ...
        function ChangePrice(user = null, business = null, user_module_price = 0) {
            ...
            $(".businesspricetext").text(parseFloat(businesspricetext).toFixed(2) + currancy_symbol);
            $(".total").text(parseFloat(total).toFixed(2) + currancy_symbol);
        ...
        $(document).on("click", ".switch-change", function() {
            ...
            $(".plan-price-text").text(super_currency_format_with_sym(planprice));
            $(".plan-time-text").text(time);

            $(".planpricetext").text(planprice + currancy_symbol);
            $(".business-price").text('( Per Work ' + businessprice + currancy_symbol + ')');
