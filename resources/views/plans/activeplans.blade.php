            ...
            <div class="card package-main-wrp">
                <div class="card-body">
                    @if (admin_setting('custome_package') == 'on' && admin_setting('plan_package') == 'on')
                        <div class="row">
                            <div class=" col-12">
                                <div class="">
                                    <div
                                        class="card-body package-card-inner  d-flex align-items-center justify-content-center mb-2 p-0">
                                        <div class="tab-main-div">
                                            <div class="nav-pills">
                                                <a class="nav-link active p-2" href="{{ route('active.plans') }}"
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true">{{ __('Pre-Packaged Subscription') }}</a>
                                            </div>
                                            <div class="nav-pills">
                                                <a class="nav-link  p-2"
                                                    href="{{ route('plans.index', ['type' => 'subscription']) }}"
                                                    role="tab" aria-controls="pills-home"
                    ...
                    @if (admin_setting('plan_package') == 'on')
                        <div class="plan-package pb-4 px-3">
                            <div class="plan-package-title pb-3">
                                            ...
                                            @foreach ($plan as $single_plan)
                                                ...
                                                <div class="basic-plan-card">
                                                    ...
                                                    <ul class="basic-plan-ul compare-plan-opction p-0">
                                                        ...
                                                        @endforeach
                                                        <li class="plan-btn">
                                                            <div class="d-flex flex-wrap w-100 px-2 text-center gap-2 justify-content-center">
                                                                ...
                                                                @else
                                                                    <a href="{{ route('plan.buy', \Illuminate\Support\Facades\Crypt::encrypt($single_plan->id)) }}"
                                                                        class="btn btn-primary text-center">{{ __('Subscription') }}</a>
                                                                    ...
                                                                    @if ($single_plan->trial == 1 && $single_plan->is_free_plan != 1 && empty(\Auth::user()->trial_expire_date))
                                                                        <a href="{{ route('plan.trial', \Illuminate\Support\Facades\Crypt::encrypt($single_plan->id)) }}"
                                                                            class="btn btn-outline-dark text-center">{{ __('Start Free Trial') }}</a>
                                                                    @endif
                                                                @endif
                                                            </div>
