            ...
            <div class="card package-main-wrp">
                <div class="card-body">
                    @if (admin_setting('custome_package') == 'on' && admin_setting('plan_package') == 'on')
                        <div class="package-card-inner  d-flex align-items-center justify-content-center my-0">
                    ...
                    @if (admin_setting('plan_package') == 'on')
                        <div class="row">
                            <div class="col mb-4">
                                <div class="float-end">
                                    <a href="#" data-size="lg" data-url="{{ route('plans.create') }}"
                                        data-ajax-popup="true" data-bs-toggle="tooltip" title=""
                                        data-title="Create New Plan" class="btn btn-sm btn-primary"
                                            ...
                                            @foreach ($plan as $single_plan)
                                                ...
                                                <div class="basic-plan-card">
                                                    <div class="basic-plan text-center mb-4">
                                                        <div class="plan-btn-wrapper d-flex align-items-center justify-content-center gap-2 mb-2">
                                                            <div class="form-check form-switch custom-switch-v1">
                                                                <input type="hidden" name="plan_enable" value="off">
                                                                <input type="checkbox"
                                                                    data-plan-id="{{ $single_plan->id }}"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    onclick="togglePlan(this)"
                                                                    title="{{ __('Enable/Disable') }}"
                                                                    class="form-check-input input-primary"
                                                                    {{ isset($single_plan->is_enabled) && $single_plan->is_enabled == 1 ? 'checked="checked"' : '' }}>
                                                            </div>
                                                            <a href="#" class="btn btn-sm bg-info"
                                                                data-url="{{ route('plans.edit', $single_plan->id) }}"
                                                                data-ajax-popup="true" data-title="Edit Plan"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            @if ($single_plan->id != 1)
                                                                ...
                                                                <a href="#!"
                                                                    class="btn btn-sm btn-danger align-items-center text-white show_confirm"
                                                        ...
                                                        <ul class="plan-info m-auto">
                                                            ...
                                                            <li>
                                                                ...
                                                                <span>{{ __('Max Business :') }}
                                                                    <b>{{ $single_plan->number_of_business == -1 ? 'Unlimited' : (!empty($single_plan->number_of_business) ? $single_plan->number_of_business : 'Unlimited') }}</b></span>
                                                            </li>
                                                            <li>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="9"
                                                                    height="8" viewBox="0 0 9 8" fill="none">
