{{ Form::model($addon, ['route' => ['add-one.detail.save', $addon->id], 'method' => 'post','enctype'=>'multipart/form-data','class'=>'needs-validation','novalidate']) }}
...
<div class="modal-footer gap-3">
    ...
    {{ Form::submit(__('Save'), ['class' => 'btn m-0 btn-primary']) }}
</div>
{{ Form::close() }}
