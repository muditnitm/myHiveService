@php
    ...
    $businessprice = !empty($plan) ? $plan->price_per_business_monthly : 0;
    $businesspriceyearly = !empty($plan) ? $plan->price_per_business_yearly : 0;
                ...
                <div class="card-body">
                    @if (admin_setting('custome_package') == 'on' && admin_setting('plan_package') == 'on')
                        <div class=" col-12">
                            <div class="">
                                <div
                                    class="card-body package-card-inner  d-flex align-items-center justify-content-center p-0 mb-2">
                                    <div class="tab-main-div">
                                        <div class="nav-pills">
                                            <a class="nav-link  p-2" href="{{ route('active.plans') }}" role="tab"
                                                aria-controls="pills-home"
                                                aria-selected="true">{{ __('Pre-Packaged Subscription') }}</a>
                                        </div>
                                        <div class="nav-pills">
                                            <a class="nav-link active p-2"
                                                href="{{ route('plans.index', ['type' => 'subscription']) }}" role="tab"
                                                aria-controls="pills-home"
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-body package-card-inner  d-flex align-items-center">
                                                        <div
                                                            class="package-itm theme-avtar badge p-2 px-3 border border-secondary">
                                                        ...
                                                        <div class="package-content flex-grow-1  px-3">
                                                            ...
                                                            <div class="text-muted"> <a
                                                                    href="#activated-add-on">{{ __(count($purchaseds) . ' Premium Add-on Activated') }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="price text-sm-end">
                                                            <small>{{ SubscriptionDetails()['status'] == true ? SubscriptionDetails()['billing_type'] : '' }}</small>
                                                            <h5>{{ SubscriptionDetails()['status'] == true ? SubscriptionDetails()['total_user'] . ' ' . __('Users') : '' }}
                                                            </h5>
                                                            <h5>{{ SubscriptionDetails()['status'] == true ? SubscriptionDetails()['total_business'] . ' ' . __('Business') : '' }}
                                                            </h5>
                                                            <span
                                                                class="time-lbl text-muted">{{ SubscriptionDetails()['status'] == true && SubscriptionDetails()['plan_expire_date'] != null ? __('Expired At ') . SubscriptionDetails()['plan_expire_date'] : '' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body package-card-inner  d-flex align-items-center">
                                                    ...
                                                    <div class="package-content flex-grow-1  px-3">
                                                        ...
                                                        <div class="text-muted"><a
                                                                href="#add-on-list">{{ __('+' . count($modules) + count($purchaseds) . ' Premium Add-on') }}</a>
                                                        </div>
                                                    </div>
                                                    <div class="price text-end">
                                                        ...
                                                        <span
                                                            class="time-lbl text-muted plan-time-text">{{ __('/Month') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="event-cards row px-0">
                                                @if (count($modules) > 0)
                                                    <h5 class="mb-3" id="add-on-list">{{ __('Modules') }}</h5>
                                                    @foreach ($modules as $module)
                                                        @if (!isset($module->display) || $module->display == true)
                                                            <div class="col-xxl-3 col-xl-6 col-lg-4 col-md-4 col-sm-6 product-card active-addon-card ">
                                                                    ...
                                                                    <div class="card user_module">
                                                                        <div class="product-img">
                                                                            ...
                                                                            <div class="checkbox-custom">
                                                                                <input type="checkbox"
                                                                                    {{ isset($session) && !empty($session) && in_array($module->name, explode(',', $session['user_module'])) ? 'checked' : '' }}
                                                                        ...
                                                                        <div class="product-content">
                                                                            ...
                                                                            <div
                                                                                class="price d-flex justify-content-between">
                                                ...
                                                @if (!empty($purchaseds))
                                                    ...
                                                    @foreach ($purchaseds as $purchased)
                                                        @if (!isset($purchased->display) || $purchased->display == true)
                                                            <div
                                                                class="col-xxl-3 col-xl-6 col-lg-4 col-md-4 col-sm-6 product-card active-addon-card">
                                                                <div class="card active_module">
                                                                    <div class="product-img">
                                                                        ...
                                                                        <div class="checkbox-custom">
                                                                            <div class="action-btn">
                                                                                {{ Form::open(['route' => ['cancel.add.on', \Illuminate\Support\Facades\Crypt::encrypt($purchased->name)], 'class' => 'm-0']) }}
                                                                                @method('GET')
                                                                                <a href="#"
                                                                                    class="btn btn-sm  bg-danger align-items-center bs-pass-para show_confirm"
                                                                                    data-bs-toggle="tooltip" title=""
                                                                                    data-bs-original-title="Cancel Add-on"
                                                                                    aria-label="Delete"
                                                                                    data-confirm="{{ __('Are You Sure?') }}"
                                                                                    data-text="{{ __('Cancel Add-on. Do you want to continue?') }}"
                                                                                    data-confirm-yes="delete-form-{{ $purchased->name }}">
                                                                                    <i
                                                                                        class="ti ti-x text-white text-white"></i>
                                                                                </a>
                                                                                {{ Form::close() }}
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="product-content">
                                                                        ...
                                                                        <div class="price d-flex justify-content-between">
                                                                            <ins class="m-price-monthly"><span
                                                                                    class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($purchased->name)['monthly_price']) }}</span>
                                                                                <span
                                                                                    class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                                            <ins class="m-price-yearly d-none"><span
                                                                                    class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($purchased->name)['yearly_price']) }}</span>
                                                                                <span
                                                                                    class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                                                        </div>

                                                                        <a href="{{ route('software.details', $purchased->alias) }}"
                                                                            target="_new"
                                                                            class="btn  btn-outline-secondary w-100 mt-2">{{ __('View Details') }}</a>
                                ...
                                <div class="col-xxl-4 col-xl-5">
                                    <div class="card subscription-counter">
                                        <div class="card-header d-flex flex-wrap row-gaps justify-content-between">
                                        ...
                                        <div class="card-body">
                                            <div class="subscription-summery">
                                                <ul class="list-unstyled mb-0">
                                                    <li>
                                                        <span class="cart-sum-left"> <i
                                                                class="ti ti-vector-bezier m-2 ti-20"></i>{{ __('Business ') }}:</span>
                                                        <span class="cart-sum-right business_counter_text">0</span>
                                                    </li>
                                                    <li>
                                                        <span class="cart-sum-left"> <i
                                                                class="ti ti-users m-2 ti-20"></i>{{ __('Users ') }}:</span>
                                                        <span class="cart-sum-right user_counter_text">0</span>
                                                    </li>

                                                    <li class="pointer extension-trigger" data-bs-toggle="collapse"
                                                        data-bs-target="#extension_div">
                                                        <span class="cart-sum-left"><i
                                                                class="ti ti-3d-cube-sphere m-2 ti-20"></i>{{ __('Extension') }}:</span>
                                                ...
                                                <div class="summery-footer">
                                                    <div class="user-qty">
                                                        <div class="lbl"> {{ __('Choose Business') }}:</div>
                                                        <div class="qty-spinner">
                                                            <button type="button" class="quantity-decrement"
                                                                data-name = "business">
                                                                <i class="ti ti-circle-minus m-2 ti-25"></i>
                                                            </button>
                                                            <input id="business_counter" type="number"
                                                                data-cke-saved-name="quantity" name="quantity"
                                                                class="quantity" step="1" value="0"
                                                                min="0" max="1000" data-name = "business">
                                                    ...
                                                    <div class="user-qty">
                                                        ...
                                                        <div class="qty-spinner">
                                                            ...
                                                            <input id="user_counter" type="number"
                                                                data-cke-saved-name="quantity" name="quantity"
                                                                class="quantity" step="1" value="0"
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li>
                                                            ...
                                                            <span class="cart-sum-right"><b class="planpricetext "> <span
                                                                        class="final_price">{{ $planprice > 0 ? super_currency_format_with_sym($planprice) : 'Free' }}</span></b></span>
                                                        </li>
                                                        <li>
                                                            <span class="cart-sum-left">
                                                                <h6 class="mb-0">{{ __('Business') }} <small
                                                                        class="text-muted business-price">{{ '( ' . __('Per Business') . super_currency_format_with_sym($businessprice) . ' )' }}</small>
                                                                </h6>
                                                            </span>
                                                            <span class="cart-sum-right"><b
                                                                    class="businesspricetext final_price">{{ super_currency_format_with_sym(0) }}</b></span>
                                                        </li>
                                                        <li>
                                                            <span class="cart-sum-left">
                                                            ...
                                                            <span class="cart-sum-right"><b
                                                                    class="userpricetext final_price">{{ super_currency_format_with_sym(0) }}</b></span>
                                                        </li>
                                                        <li>
                                                            <span class="cart-sum-left">
                                                            ...
                                                            <span class="cart-sum-right"><b
                                                                    class="module_price_text final_price">{{ super_currency_format_with_sym(0) }}</b></span>
                                                        </li>
                                                    </ul>
                                                        ...
                                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                                            <div class="d-flex align-items-center">
                                                                <div class="form-group w-100">
                                                                    ...
                                                                    <small
                                                                        class="text-danger">{{ __('Coupon apply only plan actual price. ') }}</small>
                                                                </div>
                                                                <div class="form-group  ms-3 mt-2 apply-coupon">
                                                                    <button type="button" class="btn  btn-primary"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-original-title="{{ __('Apply') }}"
                                                                        id="coupon-apply"><i
                                                                    ...
                                                                    <div class="card-body p-3">
                                                                        <div
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input
                                                                                    class="form-check-input x payment_method"
                                                                                    name="payment_method"
                                                                                    id="bank-payment" type="radio"
                                                                        ...
                                                                        <div class="row mt-2">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="choose-files text-sm-end">
                                                                                        <label for="temp_receipt">
                                                                                            <div class=" bg-primary "> <i
                                                                                                    class="ti ti-upload px-1"></i>
                                                                                            </div>
                                                                                            <input type="file"
                                                                                        ...
                                                                                        <p
                                                                                            class="text-danger error_msg d-none">
                                                                                            {{ __('This field is required') }}
                                                                                        </p>

                                                                                        <img class="mt-2" width="70px"
                                                                                            src=" " id="blah3">
                                                                                    </div>
                                                    ...
                                                    <div
                                                        class="cart-footer-total-row bg-primary text-white rounded p-3 d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="mini-total-price">
                                                            <div class="price">
                                                                <h3 class="text-white mb-0 total">
                                                                    {{ super_currency_format_with_sym(0) }}
                                                                </h3>
                                                                <span
                                                                    class="time-lbl plan-time-text">{{ __('/Month') }}</span>
                                                            </div>
                                                        </div>
                                                        {{ Form::open(['', 'method' => 'post', 'id' => 'payment_form', 'enctype' => 'multipart/form-data']) }}
                                                        <input type="hidden" name="businessprice_input" value="0"
                                                            class="businessprice_input">
                                                        <input type="hidden" name="business_counter_input"
                                                            value="0" class="business_counter_input">
                                                        ...
                                                        <input type="hidden" name="user_module_price_input"
                                                            value="0" class="user_module_price_input">
                                                        <input type="hidden" name="time_period" value="Month"
                                                            class="time_period_input">
                                                        <input type="hidden" name="business_module_price_input"
                                                            value="0" class="business_module_price_input">
...
@push('scripts')
                    ...
                    success: function(data) {
                        if (data != '') {
                            if (data.is_success == true) {
                                ...
                                $('.planpricetext').html('<span class="original-price">' + formatCurrency(data
                                        .price, '{{ $currency_setting }}') + '</span> / ' +
                                    '<span class="final_price">' + formatCurrency(
                                        finalPrice, '{{ $currency_setting }}') + '</span>');
                                ...
                                if (final_price_input) {
                                    ...
                                    $('#payment_form').append(
                                        '<input type="hidden" name="after_coupon_final_price" value="' +
                                        data.final_price + '" class="after_coupon_final_price">');
                                }
    ...
    <script>
        $(document).on('keyup mouseup', '#user_counter, #business_counter', function() {
            ...
            if (name == "user") {
                ...
                $(".business_counter_text").text(counter);
                $(".business_counter_input").val(counter);
                ChangePrice(null, counter)
            }
        });
    </script>
    <script>
        function ChangePrice(user = null, business = null, user_module_price = 0) {
            var userprice = '{{ $userprice }}';
            var businessprice = '{{ $businessprice }}';
            var planprice = '{{ $planprice }}';

            if ($('.switch-change').prop('checked') == true) {
                userprice = '{{ $userpriceyearly }}';
                businessprice = '{{ $businesspriceyearly }}';
                planprice = '{{ $planpriceyearly }}';
            ...
            if (business == null) {
                var business = parseInt($('.business_counter_input').val());
            }
            ...
            var userpricetext = userprice * user;
            var businesspricetext = businessprice * business;

            var total = userpricetext + user_module_price + businesspricetext + parseFloat(planprice);

            $(".total").text(formatCurrency(total, '{{ $currency_setting }}'));

            $(".userpricetext").text(formatCurrency(userpricetext, '{{ $currency_setting }}'));
            $(".businesspricetext").text(formatCurrency(businesspricetext, '{{ $currency_setting }}'));
            $(".userprice_input").val(userpricetext);
            $(".businessprice_input").val(businesspricetext);
                    ...
                    $("#extension_div").append(`<div class="col-md-6 col-sm-6  my-2">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-primary">` + formatCurrency(price,
                        '{{ $currency_setting }}') + `<span class="text-sm">` + time + `</span></h4>
                                        </div>
                                    </div>
                                </div>`);
        ...
        $('.quantity-increment').click(function() {
            ...
            if (quantity < 1000 || $(this).val() != '') {
                ...
                if (id == 'user') {
                    ...
                    $(".business_counter_text").text(quantity + 1);
                    $(".business_counter_input").val(quantity + 1);
                }
            } else {
                $(t).val(1000);
                if (id == 'user') {
                    ...
                    $(".business_counter_text").text(1000);
                    $(".business_counter_input").val(1000);
                }
            }
        ...
        $('.quantity-decrement').click(function() {
            ...
            if (quantity > 1) {
                ...
                if (id == 'user') {
                    ...
                    $(".business_counter_text").text(0);
                    $(".business_counter_input").val(0);
                }
            }
            ChangePrice()
        });
    ...
    <script>
        ...
        function SwitchChange() {
            ...
            $(".planpricetext").html('<span class="final_price">' + formatCurrency(planprice, '{{ $currency_setting }}') +
                '</span>');
            $(".user-price").text('( {{ __('Per User') }} ' + formatCurrency(userprice, '{{ $currency_setting }}') +
                ')');
            $(".userpricetext").text(formatCurrency(userpricetext, '{{ $currency_setting }}'));
            $(".business-price").text('( {{ __('Per business') }} ' + formatCurrency(businessprice,
                '{{ $currency_setting }}') + ')');
            $(".businesspricetext").text(formatCurrency(businesspricetext, '{{ $currency_setting }}'));
    ...
    @if (isset($session) && !empty($session))
        <script>
            $(document).ready(function() {
                ...
                $('#business_counter').val("{{ $session['business_counter'] }}");
                $('#business_counter').trigger('keyup')
                SwitchChange();
            });
        </script>
    @endif
