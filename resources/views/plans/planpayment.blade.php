...
@section('page-action')
    <div>
        <a href="{{ route('active.plans') }}" class="btn-submit btn btn-sm btn-primary " data-bs-toggle="tooltip"
            data-bs-placement="top" title="{{ __('Back') }}">
                                        ...
                                        <div class="mini-total-price">
                                            <div class="price">
                                                <h3 class="text-white mb-0 total">
                                                    {{ super_currency_format_with_sym($planprice) }}</h3>
                    ...
                    success: function(data) {
                        if (data != '') {
                            if (data.is_success == true) {
                                ...
                                $('.total').html('<span class="original-price">' + formatCurrency(
                                        data.price, '{{ $currency_setting }}') + '</span> / ' +
                                    '<span class="">' +
                                    formatCurrency(
