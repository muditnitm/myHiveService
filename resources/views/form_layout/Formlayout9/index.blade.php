                        ...
                        <div class="col-md-8 col-12">
                            <div class="form-right">
                                            ...
                                            <li class="stapes_status">
                                                @if (module_is_active('ShoppingCart', $business->created_by))
                                                    <div class="steps-icon">
                                                        ...
                                                        <span class="service-svg">
                                                            <svg class="vector" xmlns="http://www.w3.org/2000/svg"
                                                                width="23" height="23" viewBox="0 0 50 50"
                                                                fill="none">
                                                    ...
                                                    <div class="steps-icon">
                                                        ...
                                                        <span class="service-svg">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="23"
                                                                height="23" viewBox="0 0 100 100" fill="none">
                                                                <path
                                ...
                                <div class="myContainer">
                                    ...
                                    @stack('book_appointment_form_layout9')
