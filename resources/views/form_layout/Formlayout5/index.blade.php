            ...
            <div class="container-offset offset-left">
                <div class="form-inner">
                    ...
                    <div class="form-right-inner">
                        <img src="{{ asset('form_layouts/' . $business->layouts . '/images/layer.png') }}" alt="layer"
                            loading="lazy" class="layer layer1">
                        <img src="{{ asset('form_layouts/' . $business->layouts . '/images/layer.png') }}" alt="layer"
                            loading="lazy" class="layer layer2">
                        <img src="{{ asset('form_layouts/' . $business->layouts . '/images/layer2.png') }}"
                            alt="layer" loading="lazy" class="layer layer3">
                        <img src="{{ asset('form_layouts/' . $business->layouts . '/images/layer3.png') }}"
                            alt="layer" loading="lazy" class="layer layer4">
                        <img src="{{ asset('form_layouts/' . $business->layouts . '/images/layer4.png') }}"
                            alt="layer" loading="lazy" class="layer layer5">
                        <img src="{{ asset('form_layouts/' . $business->layouts . '/images/layer5.png') }}"
                            alt="layer" loading="lazy" class="layer layer6">
