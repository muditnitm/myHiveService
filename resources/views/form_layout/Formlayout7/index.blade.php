                        ...
                        <div class="form-box">
                            <div class="steps">
                                <ul>
                                    ...
                                    <li class="stapes_status">
                                        <span>
                                            <svg class="line-svg" xmlns="http://www.w3.org/2000/svg" width="30"
                                                ...
                                                <path d="M15 10V16.25" stroke="#999999" stroke-width="1.8"
                                        ...
                                        <span>
                                            <svg class="line-svg" xmlns="http://www.w3.org/2000/svg" width="30"
                                                ...
                                                <path d="M18.125 5.625V8.125C18.125 9.5 19.25 10.625 20.625 10.625H23.125"
                                                    stroke="#999999" stroke-width="1.7" stroke-miterlimit="10"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M10 16.25H15" stroke="#999999" stroke-width="1.7"
                                                    stroke-miterlimit="10" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M10 21.25H20" stroke="#999999" stroke-width="1.7"
                                                    stroke-miterlimit="10" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                        </span>
                                    ...
                                    <li class="stapes_status">
                                        <span>
                                            <svg class="line-svg" class="vuesax-linear-cards" width="40"
                                        ...
                                        <div class="step-btns">
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <button type="button" name="next"
                                                    class="next action-button btn sequential_button">
                                                    {{ __('Next step') }}
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="appointment-wrp Shoppint-Cart-btn">
                                        ...
                                        <div class="step-btns">
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <button type="button" name="next"
                                                    class="cart-save next action-button btn">
                                                    {{ __('Next') }}
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="appointment-wrp tab-wrp">
                                        <div class="tabs-wrapper">
                                            ...
                                            <div class="tabs-container">
                                                ...
                                                @endif
	                                            <div id="guest-user" class="tab-content appointment-form {{ (!in_array('1', $bookingModes) && in_array('2', $bookingModes)) ? 'active' : '' }}">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label>{{ __('Name') }}</label>
