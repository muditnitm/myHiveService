                ...
                <div class="form-inner">
                    ...
                    <div class="form-wrapper flex align-center">
                            ...
                            <ul>
                                ...
                                @if (module_is_active('ShoppingCart', $business->created_by) ||
                                    ...
                                    <li class="stapes_status">
                                        @if (module_is_active('ShoppingCart', $business->created_by))
                                            <span>
                                                <svg class="white-svg" xmlns="http://www.w3.org/2000/svg" width="23"
                                                    height="23" viewBox="0 0 50 50" fill="none">
                                        ...
                                        @else
                                            <span>
                                                <svg class="white-svg" xmlns="http://www.w3.org/2000/svg" width="100"
                        ...
                        <div class="myContainer">
                            ...
                            @stack('book_appointment_form_layout4')
                            @stack('shopping_cart')
                            @if ((!empty($files) && $files->value == 'on') || (!empty($custom_field) && $custom_field == 'on'))
                                <div class="step-container">
