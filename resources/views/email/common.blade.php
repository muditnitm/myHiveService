                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                                ...
                                                                <tr>
                                                                    <td style="width:110px;">
                                                                        @if (\Auth::check())
                                                                            <img alt="" height="auto" src="{{ get_file(sidebar_logo()) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110"/>
                                                                        @else
                                                                            @if (isset($business))
                                                                            <img src="{{ !empty(company_setting('logo_dark', $business->created_by, $business->id))
                                                                                ? get_file(company_setting('logo_dark', $business->created_by, $business->id))
                                                                                : get_file(
                                                                                    !empty(admin_setting('logo_dark', $business->created_by, $business->id))
                                                                                        ? admin_setting('logo_dark')
                                                                                        : 'uploads/logo/logo_dark.png',
                                                                                    $business->created_by,
                                                                                    $business->id,
                                                                                ) }}{{ '?' . time() }}"
                                                                                alt="" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110"/>
                                                                            @endif
                                                                        @endif
                                                                    </td>
                                                                </tr>
