                                ...
                                <div class="edit-btn-wrp d-flex flex-wrap align-items-center">
                                    ...
                                    @permission('user delete')
                                        ...
                                        <a href="#!" aria-label="Delete" data-confirm="{{ __('Are You Sure?') }}"
                                            data-text="{{ __('This action can not be undone. Do you want to continue?') }}"
                                            data-confirm-yes="delete-form-{{ $user->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{ __('Delete') }}" class="btn btn-sm border bs-pass-para show_confirm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                viewBox="0 0 16 16" fill="none">
                                    ...
                                    @permission('user login manage')
                                        @if ($user->is_enable_login == 1)
                                            <a href="{{ route('users.login', \Crypt::encrypt($user->id)) }}"
                                                ...
                                                data-bs-original-title="{{ __('Login Disable') }}" data-bs-toggle="tooltip"
                                                data-bs-placement="top">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
                                        ...
                                        @elseif ($user->is_enable_login == 0 && $user->password == null)
                                            <a href="#"
                                                data-url="{{ route('users.reset', \Crypt::encrypt($user->id)) }}"
                                                data-ajax-popup="true" data-size="md" class="btn btn-sm border login_enable"
                                                data-title="{{ __('New Password') }}"
                                                data-bs-original-title="{{ __('Login Enable') }}" data-bs-toggle="tooltip"
                                                data-bs-placement="top">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
                                                    <g clip-path="url(#clip0_11_8451)">
                                        ...
                                        @else
                                            <a href="{{ route('users.login', \Crypt::encrypt($user->id)) }}"
                                                class="btn btn-sm border" data-bs-original-title="{{ __('Login Enable') }}"
        ...
        @permission('user create')
            <div class="col-xxl-3 col-xl-4 col-md-6">
                <a href="#" class="btn-addnew-project border-primary p-4" data-ajax-popup="true" data-size="md"
                    ...
                    <h6 class="mt-2 mb-2">{{ __('New ' . $singular_name) }}</h6>
