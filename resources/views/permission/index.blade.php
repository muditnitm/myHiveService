                            ...
                            <td class="action">
                                ...
                                <span>
                                    ...
                                    <div class="action-btn ">
                                        <a  data-url="{{ route('permissions.edit',$permission->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Permission')}}" class="btn btn-outline btn-primary btn-xs blue-madison" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
