...
@php
    $path = url('packages/workdo/Photography/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('Go beyond static galleries. This theme allows you to curate your photographic journey. Organize high-resolution images by themes, projects, or even chronological order to tell a visual story.  Do not just display photos. showcase them in stunning slideshows with captivating captions that delve into your creative process.  This allows potential clients to not only see your technical skills but also understand the emotions and experiences you strive to capture in your work.') }}
                            </p>
                            <div class="price">
                                <ins><span
                                    ...
                                    <div class="tab-content active" id="tab-1">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl">{{ __('Billed monthly, or') }}
                                                <b>{{ super_currency_format_with_sym(ModulePriceByName($module->name)['monthly_price']) . '/' }}</b>{{ __(' if paid monthly') }}
                                            </div>
                                            <div class="btn-group">
                                    ...
                                    <div class="tab-content" id="tab-2">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl">{{ __('Billed yearly, or') }}
                                                <b>{{ super_currency_format_with_sym(ModulePriceByName($module->name)['yearly_price']) . '/' }}</b>{{ __(' if paid yearly') }}
                                            </div>
                                            <div class="btn-group">
                                                <a href="{{ route('apps.pricing') }}"
                                                    class="btn-secondary">{{ __('Buy Now') }} <svg
