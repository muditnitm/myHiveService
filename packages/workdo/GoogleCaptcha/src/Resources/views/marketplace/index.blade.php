...
@php
    $path = url("packages/workdo/GoogleCaptcha/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Google ')}}<b>{{__('re')}}</b>{{__('CAPTCHA')}}</h2>
                <p>{{__('reCAPTCHA is a free service from Google that helps protect websites from spam and abuse. ')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('What is reCAPTCHA?')}}</h2>
                        </div>
                        <p>{{__('CAPTCHA stands for Completely Automated Public Turing Test to tell Computers and Humans Apart. CAPTCHA is essentially a simple test that verifies that human website users are not malicious bots intent on enacting fraud and abuse on a site.

                            Google has its own version of CAPTCHA, which is called reCAPTCHA. reCAPTCHA is a free service that uses an advanced risk analysis engine and adaptive CAPTCHAs to protect websites from abusive automated software.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Why Your Website Needs reCAPTCHA')}}</h2>
                        </div>
                        <p>{{__('Hackers, bad bots, and malicious software can wreak havoc on websites that don`t have the proper protection — like reCAPTCHA — in place. To outsmart bad bots, you need the right tools working for your website. That`s where reCAPTCHA comes in. Let`s dive into how to set it up on your Morweb-powered site.')}}</p>
                    </div>
                </div>
            </div>
        </div>
