...
class CustomPageController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->isAbleTo('landingpage manage')){
            ...
            return view('landing-page::custom_page.index', compact('fontweights','font_familys','pages', 'settings','footer_sections_details'));
        }else{
    ...
    public function custom()
    {
        if(\Auth::user()->isAbleTo('landingpage manage')){
            ...
            return view('landing-page::landingpage.custom.index', compact('fontweights','font_familys','pages', 'settings','footer_sections_details'));
        }else{
    ...
    {
        return view('landing-page::custom_page.create');
    }
    ...
    public function edit($key)
    {
        ...
        $pages = json_decode($settings['menubar_page'], true);
        $page = $pages[$key];
        return view('landing-page::custom_page.edit', compact('page', 'key'));
    }
    ...
    public function customPage($slug)
    {
        ...
        foreach ($pages as $key => $page) {
            if($page['page_slug'] == $slug){
                return view('landing-page::layouts.custompage', compact('layout','page', 'settings'));
            }
        }
