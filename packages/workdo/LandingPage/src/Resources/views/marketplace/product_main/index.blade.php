            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="card">
                        ...
                        {{ Form::open(['route' => ['product_main_store', $slug], 'method' => 'post', 'enctype' => 'multipart/form-data','class'=>'needs-validation','novalidate']) }}
                        <div class="card-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('product_main_demo_button_text', $settings['product_main_demo_button_text'], ['class' => 'form-control', 'placeholder' => __('Enter Button Text'),'required' => 'required']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="logo-content mt-4">
                                            <img id="image"
                                                src="{{ check_file($settings['product_main_banner']) ? get_file($settings['product_main_banner']) : asset($old_path . '/image1.png') }}"
