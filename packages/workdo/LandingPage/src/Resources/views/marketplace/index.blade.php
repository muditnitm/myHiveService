                        ...
                        <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                            <div class="pdp-summery">
                                ...
                                <div class="cart-view btn-group">
                                    ...
                                    <a href="{!! $marketplace['product_main_demo_link'] !!}" class="link-btn">{!! $marketplace['product_main_demo_button_text'] !!} <svg
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                            <div class="pdp-image-wrapper">
                                <div class="pdp-media banner-img-wrapper">
                                    ...
                                    <img src="{{ check_file($marketplace['product_main_banner']) ? get_file($marketplace['product_main_banner']) : get_file($old_path . '/image1.png') }}"
        ...
        @if ($marketplace['dedicated_theme_section_status'] == 'on')
            <section class="dedicated-themes-section ">
                <div class="container">
                    ...
                    @if (is_array(json_decode($marketplace['dedicated_theme_sections'], true)) ||
                            is_object(json_decode($marketplace['dedicated_theme_sections'], true)))
                        @php
                            $img = 2;
                        @endphp
                                ...
                                <div class="row row-gap padding-bottom ">
                                    <div class="col-lg-5 col-md-6 col-12">
                                        <div class="abt-theme">
                                            ...
                                            @if (
                                                !empty($value['dedicated_theme_section_cards'][1]['title']) &&
                                                    $value['dedicated_theme_section_cards'][1]['title'] != null &&
                                                    $value['dedicated_theme_section_cards'][1]['title'] != '')
                                    ...
                                    <div class="col-lg-7 col-md-6 col-12">
                                        <div class="dash-theme-preview">
                                            <img src="{{ check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : (check_file($old_path . '/image' . $img . '.png') ? get_file($old_path . '/image' . $img . '.png') : get_file($old_path . '/image1.png')) }}"
                                                alt="" class="inner-frame-img">
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <span class="acnav-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="white"></path>
                                                                        <defs>
                                                                            <filter id="filter0_d_14_1908" x="0"
                                                                                y="1.55957" width="30" height="31"
                                                                                filterUnits="userSpaceOnUse"
                                                                                color-interpolation-filters="sRGB">
                                                                                <feFlood flood-opacity="0"
                                                                                    result="BackgroundImageFix">
                                        ...
                                        <div class="tab-content active" id="tab-1">
                                            <div class="pricing-content">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{!! $marketplace['pricing_plan_demo_link'] !!}"
                                                        class="link-btn">{!! $marketplace['pricing_plan_demo_button_text'] !!}<svg
        ...
        <section class="screenshot-section padding-top">
            <div class="container">
                <div class="screenshot-slider">
                    @if (is_array(json_decode($marketplace['screenshots'], true)) ||
                            is_object(json_decode($marketplace['screenshots'], true)))
                        @foreach (json_decode($marketplace['screenshots'], true) as $key => $value)
                            ...
                            <div class="screenshot-itm">
                                <div class="screenshot-image">
                                    <a href="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) : (check_file($old_path . '/image' . $imageKey . '.png') ? get_file($old_path . '/image' . $imageKey . '.png') : get_file($old_path . '/image3.png')) }}"
                                        target="_blank" class="img-zoom">
                                        <img src="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) : (check_file($old_path . '/image' . $imageKey . '.png') ? get_file($old_path . '/image' . $imageKey . '.png') : get_file($old_path . '/image3.png')) }}"
                                            alt="" class="inner-frame-img">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                        <div class="product-card-inner">
                                            ...
                                            <div class="product-content">
                                                <h4> <a
                                                        href="product.html">{{ $module->alias }}</a>
                                                </h4>
                                                <div class="price">
                                                    <ins><span
                                                            class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span>
                                                ...
                                                <a href="{{ route('software.details', $module->alias) }}"
                                                    target="_new" class="btn cart-btn">{{ __('View Details') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
