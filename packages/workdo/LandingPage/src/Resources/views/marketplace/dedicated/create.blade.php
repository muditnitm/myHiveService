                    ...
                    <div id="add-cards1" class="row">
                        <div class="col-md-10 col-12">
                            <div class="form-group">
                                ...
                                {{ Form::text('dedicated_theme_section_cards[1][title]', null, ['class' => 'form-control', 'placeholder' => __('Enter Title'),'required' => 'required']) }}
                            </div>
                            <div class="form-group">
                                {{ Form::label('Description', __('Description'), ['class' => 'form-label']) }}
                                {{ Form::text('dedicated_theme_section_cards[1][description]',null, ['class' => 'form-control ', 'placeholder' => __('Enter Description'),'required' => 'required']) }}
                            </div>
                        </div>
