...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12 page_url">
            ...
            {{ Form::text('page_url', isset($page['page_url']) && !empty($page['page_url']) ? $page['page_url'] : '', ['class' => 'form-control font-style', 'id' => 'page_url_input', 'placeholder' => __('Enter Page URL'), 'required' => 'required ']) }}
        </div>

        <div class="form-group col-md-12 page_content">
            {{ Form::label('name', __('Page Short Description'), ['class' => 'form-label']) }}
            {{ Form::text('menubar_page_short_description', isset($page['menubar_page_short_description']) && !empty($page['menubar_page_short_description']) ? $page['menubar_page_short_description'] : '', ['class' => 'form-control font-style', 'id' => 'menubar_page_short_description', 'placeholder' => __('Enter Page Short Description'), 'required' => 'required']) }}
        </div>
...
<script>
    ...
    $('input[name="template_name"]').change(function() {
        ...
        if (radioValue === "page_content") {
            ...
            $('#menubar_page_contant').attr('required', 'required');
        } else {
            ...
            $('#menubar_page_contant').removeAttr('required');
        }
    });
</script>
