...
@section('content')
                            ...
                            <div class="summery-footer">
                                <div class="user-qty">
                                    ...
                                    <div class="qty-spinner">
                                        <button type="button" class="quantity-decrement" data-name = "business">
                                        ...
                                        <input id="business_counter" type="number" data-cke-saved-name="quantity"
                                            name="quantity" class="quantity" step="1" value="0"
                                            min="0" max="1000" data-name = "business">
                                        <button type="button" class="quantity-increment " data-name = "business">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <path
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <span class="cart-sum-right"><b
                                                class="planpricetext">{{ super_currency_format_with_sym($planprice) }}</b></span>
                                    </li>
                                    <li>
                                        <span class="cart-sum-left">
                                            <h6 class="mb-0">{{ __('Business') }} <small
                                                    class="text-muted business-price">{{ super_currency_format_with_sym($businessprice) }}</small>
                                            </h6>
                                        </span>
                                        <span class="cart-sum-right"><b
                                                class="businesspricetext">{{ super_currency_format_with_sym(0) }}</b></span>
                                    </li>
                                    <li>
                                        <span class="cart-sum-left">
                                            <h6 class="mb-0">{{ __('Users') }} <small
                                                    class="text-muted user-price">{{ super_currency_format_with_sym($userprice) }}</small>
                                            </h6>
                                        </span>
                                        <span class="cart-sum-right"><b
                                ...
                                <div class="cart-footer-total-row d-flex align-items-center justify-content-between">
                                    ...
                                    <input type="hidden" name="business_counter_input" value="0"
                                        class="business_counter_input">
    ...
    <!-- wrapper end -->
    @if (isset($admin_settings['signup']) && $admin_settings['signup'] == 'on')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="store_name" placeholder="Enter Business" type="text"
                                        class="form-control" name="business_name" value="" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
...
@push('scripts')
    ...
    <script>
        $(document).on("click", ".switch-change", function() {
            ...
            $(".business-price").text('( Per Work ' + formatCurrency(businessprice, '{{ $currency_setting }}') +
                ')');
    ...
    <script>
        $(document).on("click", ".user-register-btn", function() {
            var business_counter = $('.business_counter_input').val();
            var businessprice = $('.businessprice_input').val();
            ...
            formData.append("business_counter", business_counter);
            formData.append("businessprice", businessprice);
    ...
    <script>
        $(document).on("click", ".register-form-btn", function() {
            ...
            if (status == true) {
                ...
                toastrs('Success', '{{ __('Register Successfull!') }}', 'success')
            }
        });
    </script>
    @if (module_is_active('GoogleCaptcha') &&
