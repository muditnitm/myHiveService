                ...
                languages: {
                    'en': {
                        consent_modal: {
                            ...
                            description: '{{$settings['cookie_description']}}. <button type="button" data-cc="c-settings" class="cc-link">{{__('Let me choose')}}</button>',
                            primary_btn: {
                                text: 'Accept all',
                        ...
                        settings_modal: {
                            ...
                            blocks: [{
                                ...
                                title: "{{$settings['strictly_cookie_title']}}",
                                description: '{{$settings['strictly_cookie_description']}}',
                                toggle: {
                                    value: 'necessary',
                                    enabled: true,
