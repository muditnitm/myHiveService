            ...
            <div class="form-group">
                ...
                <div class="logo-content mt-4 pb-5">
                    {{-- <img height="200px" id="image" src="{{ get_file($other_features['other_features_image'])}}"
                        ...
                        <img height="200px" id="image" src="{{ check_file($other_features['other_features_image']) ? get_file($other_features['other_features_image']) : $old_path. '/' . $other_features['other_features_image'] }}"
                        class="w-50 logo"  style="filter: drop-shadow(2px 3px 7px #011C4B);">
                </div>
