...
{{ Form::open(array('route' => 'homesection.store', 'method'=>'post', 'enctype' => "multipart/form-data",'id' => "imageUploadForm", 'class' => 'needs-validation', 'novalidate')) }}
    <div class="border rounded overflow-hidden mt-3">
        <div class="row p-3">
            <div class="col-md-6">
                <div class="form-group">
                    {{ Form::label('Offer Text', __('Offer Text'), ['class' => 'form-label']) }}
                    {{ Form::text('home_offer_text', $settings['home_offer_text'], ['class' => 'form-control', 'placeholder' => __('70% Special Offer'),'required' => 'required']) }}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('home_link_button_text',$settings['home_link_button_text'], ['class' => 'form-control', 'placeholder' => __('Enter Button Text'),'required' => 'required']) }}
                </div>
            </div>
            <div class="col-md-6">
                <div class="row pb-3">
                    ...
                    <div class="col-auto text-end">
                        <button class="btn btn-sm btn-primary btn-icon m-1 " data-repeater-create type="button" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Create Logo"><i class="ti ti-plus"></i></button>
                    </div>
                </div>
