{{ Form::open(array('route' => array('review_update', $key), 'method'=>'post', 'enctype' => "multipart/form-data",'class' => 'needs-validation','novalidate')) }}
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('review_live_demo_button_text',$review['review_live_demo_button_text'], ['class' => 'form-control', 'placeholder' => __('Enter Button Text'),'required'=>'required']) }}
                </div>
            </div>
