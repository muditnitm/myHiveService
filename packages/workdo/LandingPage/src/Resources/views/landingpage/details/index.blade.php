                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="form-check form-switch custom-switch-v1">
                                                    ...
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_top_bar_active" id="is_top_bar_active"
                                    ...
                                    <h2 class="accordion-header" id="heading-3">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="me-2">{{ __('On/Off') }}:</span>
                                                <div class="form-check form-switch custom-switch-v1">
                                                    <input type="hidden" name="is_features_section_active"
                                                        value="off">
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_features_section_active" id="is_features_section_active"
                                    ...
                                    <h2 class="accordion-header" id="heading-4">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="me-2">{{ __('On/Off') }}:</span>
                                                <div class="form-check form-switch custom-switch-v1">
                                                    <input type="hidden" name="is_reviews_section_active"
                                                        value="off">
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_reviews_section_active" id="is_reviews_section_active"
                                    ...
                                    <h2 class="accordion-header" id="heading-5">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="me-2">{{ __('On/Off') }}:</span>
                                                <div class="form-check form-switch custom-switch-v1">
                                                    <input type="hidden" name="is_screenshots_section_active"
                                                        value="off">
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_screenshots_section_active"
                                                        id="is_screenshots_section_active"
                                    ...
                                    <h2 class="accordion-header" id="heading-6">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="me-2">{{ __('On/Off') }}:</span>
                                                <div class="form-check form-switch custom-switch-v1">
                                                    <input type="hidden" name="is_dedicated_section_active"
                                                        value="off">
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_dedicated_section_active"
                                                        id="is_dedicated_section_active"
                                    ...
                                    <h2 class="accordion-header" id="heading-7">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="me-2">{{ __('On/Off') }}:</span>
                                                <div class="form-check form-switch custom-switch-v1">
                                                    <input type="hidden" name="is_package_details_section_active"
                                                        value="off">
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_package_details_section_active"
                                                        id="is_package_details_section_active"
                                        ...
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="form-check form-switch custom-switch-v1">
                                                    ...
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_faq_section_active" id="is_faq_section_active"
                                    ...
                                    <h2 class="accordion-header" id="heading-9">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="me-2">{{ __('On/Off') }}:</span>
                                                <div class="form-check form-switch custom-switch-v1">
                                                    <input type="hidden" name="is_buildtech_section_active"
                                                        value="off">
                                                    <input type="checkbox" class="form-check-input input-primary"
                                                        name="is_buildtech_section_active"
                                                        id="is_buildtech_section_active"
