...
<div class=" modal-body-section qr-logo text-center">
    ...
    alt="{{ config('app.name', 'BookingGo') }}" class="logo logo-lg" height="60px">
</div>
<div class="modal-body qr-content border-0 pb-0">
    ...
    <script>
        $(document).ready(function() {
            ...
            var qr_font = `{{ isset($settings['qr_text']) ? $settings['qr_text'] : 'BookingGo' }}`;
            var qr_font_color =
