...
// Details Section All Routes
// top bar content save route
...
Route::get('landingpage/review/create', [ReviewController::class, 'review_create'])
    ->name('landingpage.review.create')
    ->middleware(['web','auth']);
...
Route::get('landingpage/review/edit/{key}', [ReviewController::class, 'review_edit'])
    ->name('landingpage_review_edit')
    ->middleware(['web','auth']);
...
Route::get('landingpage/review/delete/{key}', [ReviewController::class, 'review_delete'])
    ->name('landingpage_review_delete')
    ->middleware(['web','auth']);
...
// end Custom Section Route Start

// start newsletter section routes
Route::resource('join_us', JoinUsController::class)->middleware(['web','auth']);
...
Route::get('delete-pixel/{pixelId}', [PixelController::class, 'destoryPixel'])->name('destroy.pixel')->middleware(['web','auth']);
// end
...
Route::get('marketplace/{slug}/dedicated/edit/{key}/{image_no}', [MarketPlaceController::class, 'dedicated_theme_edit'])
...
Route::post('marketplace/{slug}/store', [MarketPlaceController::class, 'pricing _plan_store'])
...
Route::get('marketplace/{slug}/screenshot/edit/{key}/{image_no}', [MarketPlaceController::class, 'screenshots_edit'])
