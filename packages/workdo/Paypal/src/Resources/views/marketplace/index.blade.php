...
@php
    $path = url('/packages/workdo/Paypal/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('Check out faster, safer and more easily with PayPal, the service that lets you pay, send money, and accept payments without having to enter your financial details each time. PayPal prioritizes enabling secure transactions to allow users to send and receive money electronically. Compared to credit cards, PayPal can be considered as safe.') }}
                            </p>
                            <div class="price">
                                <ins><span
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            ...
                            <p>{{ __('Although there are dozens of payment systems online, millions of freelancers across the globe still prefer PayPal. It features a robust, widely accessible system. You can create a free PayPal account and start receiving payments within minutes.
                                                                                                                                                                                                                                                                                                                                                    Of course, using PayPal now and then is one thing, but setting it as your default payment system is another. Assess the platform’s advantages and gauge how they’ll benefit your freelance business.') }}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row row-gap">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="section-title">
                                ...
                                <p>{{ __('Access over Premium Add-ons for Stripe, Paypal, Google Recaptcha Communication, Management, and more, all in one place!') }}
                                </p>
                            </div>
