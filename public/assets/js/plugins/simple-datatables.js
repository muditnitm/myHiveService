                                    ...
                                    t.exports = (function () {
                                        var t = 1e3,
                                            ...
                                            v = {
                                                ...
                                                p: function (t) {
                                                    return (
                                                        { M: f, y: c, w: u, d: o, D: d, h: a, m: s, s: i, ms: r, Q: h }[t] ||
                                                        String(t || "")
                                                            .toLowerCase()
                                                            .replace(/s$/, "")
                                                    );
                                                ...
                                                return (
                                                    ...
                                                    (D.diff = function (r, d, l) {
                                                        var $,
                                                            ...
                                                            p = w.m(this, m);
                                                        return (
                                                            (p = (($ = {}), ($[c] = p / 12), ($[f] = p), ($[h] = p / 3), ($[u] = (v - D) / 6048e5), ($[o] = (v - D) / 864e5), ($[a] = v / n), ($[s] = v / e), ($[i] = v / t), $)[M] || v),
                                                            l ? p : w.a(p)
                                                        );
                                                    }),
                ...
                function (require, module, exports) {
                        ...
                        order(t) {
                            ...
                            t.forEach((t, i) => {
                                (n = o.headings[t]),
                                    ...
                                    (e.sortable = h),
                                    l[0].push(e),
                                    o.hiddenColumns.includes(t) || ((s = n.cloneNode(!0)), (s.originalCellIndex = i), (s.sortable = h), l[1].push(s));
                            }),
                                o.data.forEach((e, s) => {
                                    (i = e.cloneNode(!1)),
                                        (a = e.cloneNode(!1)),
                            ...
                            Promise.all(p).then((n) => {
                                ...
                                Array.from(h).forEach((e) => {
                                    ...
                                    (a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i),
                                        parseFloat(a) == a ? (l[d++] = { value: Number(a), row: e }) : (r[o++] = { value: "string" == typeof i ? i.toLowerCase() : i, row: e });
                                }),
                                    e || (e = c.classList.contains("asc") ? "desc" : "asc"),
                                    "desc" == e ? ((u = a(r, -1)), (g = a(l, -1)), c.classList.remove("asc"), c.classList.add("desc")) : ((u = a(l, 1)), (g = a(r, 1)), c.classList.remove("desc"), c.classList.add("asc")),
                                    i.lastTh && c != i.lastTh && (i.lastTh.classList.remove("desc"), i.lastTh.classList.remove("asc")),
                                    (i.lastTh = c),
                                    (h = u.concat(g)),
                                    (i.data = []);
                                const f = [];
                    ...
                    const r = function (t) {
                            ...
                            t.data &&
                                ...
                                s && (null !== this.dom.tHead && this.dom.removeChild(this.dom.tHead), this.dom.appendChild(s)),
                                i && (this.dom.tBodies.length && this.dom.removeChild(this.dom.tBodies[0]), this.dom.appendChild(i));
                        },
                        l = {
                            sortable: !0,
                            searchable: !0,
                            ...
                            hiddenHeader: !1,
                            footer: !1,
                            labels: { placeholder: "Search...", perPage: "{select} entries per page", noRows: "No entries found", noResults: "No results match your search query", info: "Showing {start} to {end} of {rows} entries" },
                    ...
                    class o {
                        constructor(t, e = {}) {
                            ...
                            if (
                                ((this.options = { ...l, ...e, layout: { ...l.layout, ...e.layout }, labels: { ...l.labels, ...e.labels } }),
                                (this.initialized = !1),
                        ...
                        render(t) {
                            ...
                            if (
                                ...
                                s.footer ? this.head && !this.foot && ((this.foot = e("tfoot", { html: this.head.innerHTML })), this.dom.appendChild(this.foot)) : this.foot && this.dom.removeChild(this.dom.tFoot),
                                (this.wrapper = e("div", { class: "dataTable-wrapper dataTable-loading" })),
                        ...
                        renderPage() {
                            ...
                            let t,
                                ...
                                a = 0;
                            if (
                                (this.totalPages && ((e = this.currentPage - 1), (i = e * this.options.perPage), (a = i + this.pages[e].length), (i += 1), (t = this.searching ? this.searchData.length : this.data.length)),
                        ...
                        fixColumns() {
                            if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                                ...
                                if (((this.columnWidths = []), this.dom.tHead)) {
                                    if (
                                        (this.options.scrollY.length && ((s = e("thead")), s.appendChild(e("tr")), (s.style.height = "0px"), this.headerTable && (this.dom.tHead = this.headerTable.tHead)),
                            ...
                            if (o.type) {
                                ...
                                if (i.length) {
                                    if ("txt" === o.type || "csv" === o.type) {
                                        ...
                                        for (r = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++)
                                            !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (r += `\`${s[n].textContent}\`,`);
                                        ...
                                        for (h = 0; h < i.length; h++)
                                            for (a[h] = a[h] || {}, n = 0; n < s.length; n++)
                                                !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (a[h][s[n].textContent] = i[h].cells[n].textContent);
                        ...
                        import(e) {
                            ...
                            if (i.data.length || t(i.data)) {
                                if ("csv" === i.type) {
                                    ...
                                    t.length &&
                                        (i.headings && ((s.headings = t[0].split(i.columnDelimiter)), t.shift()),
                                        t.forEach((t, e) => {
                                            s.data[e] = [];
                        ...
                        setMessage(t) {
                            ...
                            this.hasRows ? (s = this.data[0].cells.length) : this.activeHeadings.length && (s = this.activeHeadings.length),
                                ...
                                (this.totalPages = 0),
                                this.render("pager"),
                                this.clear(e("tr", { html: `<td class="dataTables-empty" colspan="${s}">${t}</td>` }));
                        }
                        columns(t) {
                            return new h(this, t);
                        }
